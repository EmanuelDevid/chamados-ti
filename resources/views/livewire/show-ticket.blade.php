        ...
        <div class="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <div class="flex items-center gap-2 mb-2">
                    <span class="text-xs font-mono font-bold bg-slate-200 text-slate-600 px-2.5 py-1 rounded-md border border-slate-200">
                        ...
                        @forelse($messages as $msg)
                            @if($msg->is_system_log)
                                ...
                                <div class="flex items-center justify-center my-3">
                                    <span class="bg-sky-200 text-slate-600 border border-slate-200 text-xs px-3 py-1 rounded-full flex items-center gap-1.5">
                            ...
                            @else
                                ...
                                <div class="flex gap-3 {{ $msg->user_id === auth()->id() ? 'flex-row-reverse' : '' }}">
                                    ...
                                    <div class="max-w-[80%]">
                                        ...
                                        <div class="p-3.5 rounded-2xl text-sm leading-relaxed {{ $msg->user_id === auth()->id() ? 'bg-blue-600 text-white rounded-tr-none shadow-sm' : 'bg-slate-200 text-slate-800 rounded-tl-none border border-slate-200' }}">
                                            {{ $msg->message }}
                                        </div>
                                    </div>
                                </div>
